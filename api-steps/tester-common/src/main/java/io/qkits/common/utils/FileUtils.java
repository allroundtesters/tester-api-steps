...
public class FileUtils {
    ...
    private static String getClassPath(){
        try {
            return java.net.URLDecoder.decode(FileUtils.class.getClassLoader().getResource("").getPath(),"utf-8");
    ...
    public static File writeToFile(String path,String text) {
        ...
        try {
            org.apache.commons.io.FileUtils.writeLines(file,"utf-8", texts, true);
        } catch (IOException e) {
    ...
    public static File writeToFile(String path,String text,boolean isAppend) {
        ...
        ArrayList<String> texts = Lists.newArrayList(text);
        try {
            org.apache.commons.io.FileUtils.writeLines(file,"utf-8",texts, isAppend);
        } catch (IOException e) {
            throw new RuntimeException("write file failed for "+file.getName()+"error="+e.getCause());
        }
